...
ScrollReveal().reveal(".sec-02, .container accordion, #navbar", {
  delay: 500,
  origin: "top",
});
...
var countries = ["USB-C Cable","iPhone","Apple Lightning Cable","Micro USB","Powerbank","iPhone Battery","Earpiece","Headphones","Laptop","Adapter"];
